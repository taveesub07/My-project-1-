...
public class TimelineProjectSettings : ScriptableSingleton<TimelineProjectSettings>
{
    ...
    [Obsolete("assetDefaultFramerate has been deprecated. Use defaultFrameRate instead.", true)]
    ...
    {
        get => m_DefaultFrameRate;
        set
        {
            if (!double.IsFinite(value))
                m_DefaultFrameRate = TimelineAsset.EditorSettings.kDefaultFrameRate;
            else
                m_DefaultFrameRate = Math.Max(value, TimelineAsset.EditorSettings.kMinFrameRate);
        }
    }
