...
namespace UnityEditor.Timeline
{
    class TimelineGroupGUI : TimelineTrackBaseGUI
    {
        ...
        float DrawTrackButtons(Rect headerRect, WindowState state)
        {
        ...
        public override void Draw(Rect headerRect, Rect contentRect, WindowState state)
        {
            ...
            using (new GUIGroupScope(headerRect))
            {
                ...
                groupRect.xMax = DrawTrackButtons(groupRect, state);
                DrawName(groupRect);
            }
        ...
        void DrawName(Rect rect)
        {
            ...
            if (track != null && track is GroupTrack)
                DrawNameLabel(labelRect, m_Styles.groupFont.normal.textColor, new GUIStyle(m_Styles.groupFont));
        }
